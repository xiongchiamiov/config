...
theme_path = "/home/pearson/.config/awesome/default/theme.lua"
...
-- {{{ Wibox
mytextclock = awful.widget.textclock({ align = "right" }, " %a %b %d, %I:%M ", 15)
...
for s = 1, screen.count() do
    ...
    -- Create the wibox
    mywibox[s] = awful.wibox({ position = "top", fg = beautiful.fg_normal, bg = beautiful.bg_normal })
